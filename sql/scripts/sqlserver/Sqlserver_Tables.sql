...
USE [bd_bank]
GO
ALTER TABLE taccount DROP COLUMN idsgencies

use [bd_bank]
go
ALTER TABLE taccount  ADD idAgencies int NULL DEFAULT NULL
...
DROP TABLE [dbo].[taccounttype]
GO

DROP TABLE [dbo].[tarea]
GO

DROP TABLE [dbo].[temploy_area]
GO
...
idagencies int NULL DEFAULT NULL,
