...
INSERT INTO `bd_bank`.`tdirectoragencie`(`idtdirectorAgencie`,`name`,`lastName`,`img`,`salary`)
VALUES (`aidtdirectorAgencie`,`aname`,`alastName`,`aimg`,`asalary`);
SELECT 
...
SET `idtdirectorAgencie`=`aidtdirectorAgencie`,`name`=`aname`,`lastName`=`alastName`,`img`=`aimg`,`salary`=`asalary`
